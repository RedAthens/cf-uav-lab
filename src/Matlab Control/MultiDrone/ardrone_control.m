...
% Last Modified by GUIDE v2.5 25-Sep-2017 16:59:04
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
takeoff1 = rospublisher('/ardrone1/ardrone/takeoff','std_msgs/Empty');
takeoff2 = rospublisher('/ardrone2/ardrone/takeoff','std_msgs/Empty');
takeoff3 = rospublisher('/ardrone3/ardrone/takeoff','std_msgs/Empty');
msg = rosmessage(takeoff1);
send(takeoff1,msg);
send(takeoff2,msg);
send(takeoff3,msg);
pause(1);
clear takeoff1 takeoff2 takeoff3;
disp('Takeoff!')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
land1 = rospublisher('/ardrone1/ardrone/land','std_msgs/Empty');
land2 = rospublisher('/ardrone2/ardrone/land','std_msgs/Empty');
land3 = rospublisher('/ardrone3/ardrone/land','std_msgs/Empty');
msg = rosmessage(land1);
send(land1,msg);
send(land2,msg);
send(land3,msg);
pause(1);
clear land1 land2 land3;
disp('Landing!')
...
% handles    structure with handles and user data (see GUIDATA)
disp('Emergency!!!');
reset1 = rospublisher('/ardrone1/ardrone/reset','std_msgs/Empty');
reset2 = rospublisher('/ardrone2/ardrone/reset','std_msgs/Empty');
reset3 = rospublisher('/ardrone3/ardrone/reset','std_msgs/Empty');
msg = rosmessage(reset1);
send(reset1,msg);
send(reset2,msg);
send(reset3,msg);
pause(1);
clear reset1 reset2 reset3;
