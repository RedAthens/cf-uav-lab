function [ waypoint ] = getWaypoints2(  )
% Number of waypoints. Edit this value as desired. 
nPoints = 4;
origin_point2 = [0.3;0;0;0;0];
waypointsListARDrone = zeros(5,nPoints);

% waypointsListARDrone(:,k) = [ Xe (m), Ye (m), h (m) , yaw,waiting time
waypointsListARDrone(:,1) = origin_point2+[0;0;0.9;0;5] ;
waypointsListARDrone(:,2) = origin_point2+[0;0;1.0;0;5] ;
waypointsListARDrone(:,3) = origin_point2+[0;0;1.1;0;5] ;
waypointsListARDrone(:,4) = origin_point2+[0;0;1.3;0;5] ;
